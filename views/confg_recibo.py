...
################################################################################
## Form generated from reading UI file 'confg_recibo.ui'
##
...
class Confg_Recibos(object):
    def setupUi(self, Confg_Recibos):
        if not Confg_Recibos.objectName():
            Confg_Recibos.setObjectName(u"Confg_Recibos")
        Confg_Recibos.resize(586, 441)
        Confg_Recibos.setStyleSheet(u"background-color: rgb(0, 0, 0);\n"
"")
        self.frame = QFrame(Confg_Recibos)
        ...
        self.Cancelar.setIconSize(QSize(32, 32))
        self.label_19 = QLabel(self.frame)
        self.label_19.setObjectName(u"label_19")
        self.label_19.setGeometry(QRect(500, 180, 61, 61))
        self.label_19.setPixmap(QPixmap(u"../assets/img_ui/recibo_default.png"))
        ...
        self.frame_2 = QFrame(Confg_Recibos)
...
"}")
        ...
        self.retranslateUi(Confg_Recibos)

        QMetaObject.connectSlotsByName(Confg_Recibos)
    # setupUi

    def retranslateUi(self, Confg_Recibos):
        Confg_Recibos.setWindowTitle(QCoreApplication.translate("Confg_Recibos", u"Editar Producto", None))
        self.label.setText(QCoreApplication.translate("Confg_Recibos", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">Configuraci\u00f3n de Recibo</span></p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("Confg_Recibos", u"Ganacia  :", None))
        self.label_13.setText(QCoreApplication.translate("Confg_Recibos", u"Descuento :", None))
        self.label_17.setText(QCoreApplication.translate("Confg_Recibos", u"Imagen por defecto de producto:", None))
        self.b.setText("")
        self.agregar.setText(QCoreApplication.translate("Confg_Recibos", u"GUARDAR", None))
        self.Cancelar.setText(QCoreApplication.translate("Confg_Recibos", u"CANCELAR", None))
        self.label_19.setText("")
        self.label_20.setText(QCoreApplication.translate("Confg_Recibos", u"<html><head/><body><p><span style=\" font-size:7pt; font-weight:600;\">GANANCIA MAX </span></p><p><span style=\" font-size:7pt; font-weight:600;\">DE *1.3%</span></p></body></html>", None))
        self.label_21.setText(QCoreApplication.translate("Confg_Recibos", u"<html><head/><body><p><span style=\" font-size:7pt; font-weight:600;\">DESCUENTO MAX </span></p><p><span style=\" font-size:7pt; font-weight:600;\">DE *0.1%</span></p></body></html>", None))
        ...
        self.label_3.setText(QCoreApplication.translate("Confg_Recibos", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Cerrar</span></p></body></html>", None))
        self.label_4.setText(QCoreApplication.translate("Confg_Recibos", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Cerrar</span></p></body></html>", None))
        self.label_5.setText(QCoreApplication.translate("Confg_Recibos", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Sesion</span></p></body></html>", None))
        self.label_6.setText(QCoreApplication.translate("Confg_Recibos", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">A\u00f1adir</span></p></body></html>", None))
        self.label_7.setText(QCoreApplication.translate("Confg_Recibos", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Usuario</span></p></body></html>", None))
        self.label_8.setText(QCoreApplication.translate("Confg_Recibos", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Ver todos</span></p></body></html>", None))
        self.label_9.setText(QCoreApplication.translate("Confg_Recibos", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600; font-style:italic; color:#2d2d2d;\">los Usrs.</span></p></body></html>", None))
        self.label_10.setText(QCoreApplication.translate("Confg_Recibos", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Confg.</span></p></body></html>", None))
        self.label_11.setText(QCoreApplication.translate("Confg_Recibos", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Tu</span></p></body></html>", None))
        self.label_12.setText(QCoreApplication.translate("Confg_Recibos", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Cuenta</span></p></body></html>", None))
    # retranslateUi
