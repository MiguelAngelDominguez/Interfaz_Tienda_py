...
class EditBook(object):
    def setupUi(self, EditBook):
        if not EditBook.objectName():
            EditBook.setObjectName(u"EditBook")
        EditBook.resize(586, 671)
        EditBook.setStyleSheet(u"background-color: rgb(0, 0, 0);\n"
"")
        self.frame = QFrame(EditBook)
...
"}")
    ...
    def retranslateUi(self, EditBook):
        EditBook.setWindowTitle(QCoreApplication.translate("EditBook", u"Editar Producto", None))
        self.label.setText(QCoreApplication.translate("EditBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">Editar Productos</span></p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("EditBook", u"Nombre :", None))
        self.label_13.setText(QCoreApplication.translate("EditBook", u"Marca :", None))
        self.label_14.setText(QCoreApplication.translate("EditBook", u"Precio de Compra :", None))
        self.label_15.setText(QCoreApplication.translate("EditBook", u"Precio de Venta Sugerible :", None))
        self.label_16.setText(QCoreApplication.translate("EditBook", u"Cantidad :", None))
        self.label_17.setText(QCoreApplication.translate("EditBook", u"Imagen del Producto :", None))
        self.pushButton.setText("")
        self.label_18.setText(QCoreApplication.translate("EditBook", u"Descripcion :", None))
        self.agregar.setText(QCoreApplication.translate("EditBook", u"GUARDAR", None))
        self.Cancelar.setText(QCoreApplication.translate("EditBook", u"CANCELAR", None))
        ...
        self.label_3.setText(QCoreApplication.translate("EditBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Cerrar</span></p></body></html>", None))
        self.label_4.setText(QCoreApplication.translate("EditBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Cerrar</span></p></body></html>", None))
        self.label_5.setText(QCoreApplication.translate("EditBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Sesion</span></p></body></html>", None))
        self.label_6.setText(QCoreApplication.translate("EditBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">A\u00f1adir</span></p></body></html>", None))
        self.label_7.setText(QCoreApplication.translate("EditBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Usuario</span></p></body></html>", None))
        self.label_8.setText(QCoreApplication.translate("EditBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Ver todos</span></p></body></html>", None))
        self.label_9.setText(QCoreApplication.translate("EditBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600; font-style:italic; color:#2d2d2d;\">los Usrs.</span></p></body></html>", None))
        self.label_10.setText(QCoreApplication.translate("EditBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Confg.</span></p></body></html>", None))
        self.label_11.setText(QCoreApplication.translate("EditBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Tu</span></p></body></html>", None))
        self.label_12.setText(QCoreApplication.translate("EditBook", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Cuenta</span></p></body></html>", None))
    # retranslateUi
