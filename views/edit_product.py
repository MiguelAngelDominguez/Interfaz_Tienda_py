...
class Editar_producto(object):
    def setupUi(self, Editar_producto):
        if not Editar_producto.objectName():
            Editar_producto.setObjectName(u"Editar_producto")
        Editar_producto.resize(586, 671)
        Editar_producto.setStyleSheet(u"background-color: rgb(0, 0, 0);\n"
"")
        self.frame = QFrame(Editar_producto)
        self.frame.setObjectName(u"frame")
        self.frame.setGeometry(QRect(10, 0, 571, 551))
        self.frame.setStyleSheet(u"background-color: rgb(39, 39, 39);")
        self.frame.setFrameShape(QFrame.StyledPanel)
        self.frame.setFrameShadow(QFrame.Raised)
        self.label = QLabel(self.frame)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(140, 20, 281, 31))
        ...
        self.b.setGeometry(QRect(420, 335, 41, 31))
        ...
        self.descripcion.setGeometry(QRect(20, 410, 541, 71))
        ...
        self.agregar.setGeometry(QRect(140, 500, 131, 41))
        font1 = QFont()
        ...
        self.Cancelar.setGeometry(QRect(290, 500, 131, 41))
        ...
        self.label_19.setGeometry(QRect(470, 310, 81, 71))
        self.label_19.setPixmap(QPixmap(u"../assets/img_ui/producto_default.png"))
        self.label_19.setScaledContents(True)
        self.frame_2 = QFrame(Editar_producto)
...
"}")
        ...
        self.retranslateUi(Editar_producto)

        QMetaObject.connectSlotsByName(Editar_producto)
    # setupUi

    def retranslateUi(self, Editar_producto):
        Editar_producto.setWindowTitle(QCoreApplication.translate("Editar_producto", u"Editar Producto", None))
        self.label.setText(QCoreApplication.translate("Editar_producto", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">Editar Productos</span></p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("Editar_producto", u"Nombre :", None))
        self.label_13.setText(QCoreApplication.translate("Editar_producto", u"Marca :", None))
        self.label_14.setText(QCoreApplication.translate("Editar_producto", u"Precio de Compra :", None))
        self.label_15.setText(QCoreApplication.translate("Editar_producto", u"Precio de Venta Sugerible :", None))
        self.label_16.setText(QCoreApplication.translate("Editar_producto", u"Cantidad :", None))
        self.label_17.setText(QCoreApplication.translate("Editar_producto", u"Imagen del Producto :", None))
        self.b.setText("")
        self.label_18.setText(QCoreApplication.translate("Editar_producto", u"Descripcion :", None))
        self.agregar.setText(QCoreApplication.translate("Editar_producto", u"GUARDAR", None))
        self.Cancelar.setText(QCoreApplication.translate("Editar_producto", u"CANCELAR", None))
        ...
        self.label_3.setText(QCoreApplication.translate("Editar_producto", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Cerrar</span></p></body></html>", None))
        self.label_4.setText(QCoreApplication.translate("Editar_producto", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Cerrar</span></p></body></html>", None))
        self.label_5.setText(QCoreApplication.translate("Editar_producto", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Sesion</span></p></body></html>", None))
        self.label_6.setText(QCoreApplication.translate("Editar_producto", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">A\u00f1adir</span></p></body></html>", None))
        self.label_7.setText(QCoreApplication.translate("Editar_producto", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Usuario</span></p></body></html>", None))
        self.label_8.setText(QCoreApplication.translate("Editar_producto", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Ver todos</span></p></body></html>", None))
        self.label_9.setText(QCoreApplication.translate("Editar_producto", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600; font-style:italic; color:#2d2d2d;\">los Usrs.</span></p></body></html>", None))
        self.label_10.setText(QCoreApplication.translate("Editar_producto", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Confg.</span></p></body></html>", None))
        self.label_11.setText(QCoreApplication.translate("Editar_producto", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Tu</span></p></body></html>", None))
        self.label_12.setText(QCoreApplication.translate("Editar_producto", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Cuenta</span></p></body></html>", None))
    # retranslateUi
