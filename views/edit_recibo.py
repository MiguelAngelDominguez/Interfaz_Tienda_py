...
class Editar_Recibo(object):
    def setupUi(self, Editar_Recibo):
        if not Editar_Recibo.objectName():
            Editar_Recibo.setObjectName(u"Editar_Recibo")
        Editar_Recibo.resize(587, 670)
        Editar_Recibo.setStyleSheet(u"background-color: rgb(0, 0, 0);\n"
"")
        self.frame = QFrame(Editar_Recibo)
        ...
        self.buscar_en_recibo = QPushButton(self.frame)
        self.buscar_en_recibo.setObjectName(u"buscar_en_recibo")
        self.buscar_en_recibo.setGeometry(QRect(440, 210, 121, 31))
        self.buscar_en_recibo.setStyleSheet(u"color: rgb(255, 255, 255);")
        icon = QIcon()
        icon.addFile(u"../assets/icons/new/lupa.png", QSize(), QIcon.Normal, QIcon.Off)
        self.buscar_en_recibo.setIcon(icon)
        self.label_18 = QLabel(self.frame)
        self.label_18.setObjectName(u"label_18")
        self.label_18.setGeometry(QRect(440, 430, 91, 61))
        self.label_18.setFont(font)
        self.label_18.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.guardar_recibo = QPushButton(self.frame)
        self.guardar_recibo.setObjectName(u"guardar_recibo")
        self.guardar_recibo.setGeometry(QRect(140, 490, 131, 41))
        font1 = QFont()
        font1.setPointSize(10)
        font1.setBold(True)
        font1.setWeight(75)
        self.guardar_recibo.setFont(font1)
        self.guardar_recibo.setStyleSheet(u"color: rgb(255, 255, 255);")
        icon1 = QIcon()
        icon1.addFile(u"../assets/icons/new/art_pint/documento (2).png", QSize(), QIcon.Normal, QIcon.Off)
        self.guardar_recibo.setIcon(icon1)
        self.guardar_recibo.setIconSize(QSize(35, 35))
        ...
        self.cancelado = QCheckBox(self.frame)
        self.cancelado.setObjectName(u"cancelado")
        self.cancelado.setGeometry(QRect(530, 430, 141, 61))
        self.cancelado.setStyleSheet(u"color: rgb(255, 255, 255);")
        ...
        self.agregar_producto = QPushButton(self.frame)
        self.agregar_producto.setObjectName(u"agregar_producto")
        self.agregar_producto.setGeometry(QRect(390, 210, 41, 31))
        self.agregar_producto.setFont(font1)
        self.agregar_producto.setStyleSheet(u"color: rgb(255, 255, 255);")
        icon3 = QIcon()
        icon3.addFile(u"../assets/icons/new/art_pint/anadir.png", QSize(), QIcon.Normal, QIcon.Off)
        self.agregar_producto.setIcon(icon3)
        self.agregar_producto.setIconSize(QSize(20, 20))
        self.frame_2 = QFrame(Editar_Recibo)
...
"}")
        ...
        self.retranslateUi(Editar_Recibo)

        QMetaObject.connectSlotsByName(Editar_Recibo)
    # setupUi

    def retranslateUi(self, Editar_Recibo):
        Editar_Recibo.setWindowTitle(QCoreApplication.translate("Editar_Recibo", u"Agregar Producto", None))
        self.label.setText(QCoreApplication.translate("Editar_Recibo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">Editar Recibo</span></p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("Editar_Recibo", u"Nombre del Cliente :", None))
        self.label_13.setText(QCoreApplication.translate("Editar_Recibo", u"DNI :", None))
        self.label_14.setText(QCoreApplication.translate("Editar_Recibo", u"Fecha :", None))
        self.label_15.setText(QCoreApplication.translate("Editar_Recibo", u"N\u00b0 de compra :", None))
        self.buscar_en_recibo.setText(QCoreApplication.translate("Editar_Recibo", u"Buscar productos", None))
        self.label_18.setText(QCoreApplication.translate("Editar_Recibo", u"Canselado :", None))
        self.guardar_recibo.setText(QCoreApplication.translate("Editar_Recibo", u"GUARDAR", None))
        self.Cancelar_recibo.setText(QCoreApplication.translate("Editar_Recibo", u"CANCELAR", None))
        self.cancelado.setText(QCoreApplication.translate("Editar_Recibo", u"SI", None))
        self.fecha_compra.setText(QCoreApplication.translate("Editar_Recibo", u"../../....", None))
        self.id_compra.setText(QCoreApplication.translate("Editar_Recibo", u"1234567", None))
        self.borrar_producto.setText("")
        self.agregar_producto.setText("")
        ...
        self.label_3.setText(QCoreApplication.translate("Editar_Recibo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Cerrar</span></p></body></html>", None))
        self.label_4.setText(QCoreApplication.translate("Editar_Recibo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Cerrar</span></p></body></html>", None))
        self.label_5.setText(QCoreApplication.translate("Editar_Recibo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Sesion</span></p></body></html>", None))
        self.label_6.setText(QCoreApplication.translate("Editar_Recibo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">A\u00f1adir</span></p></body></html>", None))
        self.label_7.setText(QCoreApplication.translate("Editar_Recibo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Usuario</span></p></body></html>", None))
        self.label_8.setText(QCoreApplication.translate("Editar_Recibo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Ver todos</span></p></body></html>", None))
        self.label_9.setText(QCoreApplication.translate("Editar_Recibo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600; font-style:italic; color:#2d2d2d;\">los Usrs.</span></p></body></html>", None))
        self.label_10.setText(QCoreApplication.translate("Editar_Recibo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Confg.</span></p></body></html>", None))
        self.label_11.setText(QCoreApplication.translate("Editar_Recibo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Tu</span></p></body></html>", None))
        self.label_12.setText(QCoreApplication.translate("Editar_Recibo", u"<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600; font-style:italic; color:#2d2d2d;\">Cuenta</span></p></body></html>", None))
    # retranslateUi
