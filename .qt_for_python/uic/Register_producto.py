...
################################################################################
## Form generated from reading UI file 'Register_producto.ui'
##
...
"")
        ...
        self.Ver_Productos.setGeometry(QRect(10, 140, 261, 61))
        font = QFont()
...
"}")
        ...
        self.Anadir_Productos.setGeometry(QRect(10, 280, 261, 61))
...
"}")
        ...
        self.Editar_Productos.setGeometry(QRect(10, 210, 261, 61))
...
"}")
        ...
        self.Eliminar_Productos.setGeometry(QRect(10, 350, 261, 61))
...
"}")
        ...
        self.Ajustes_Productos.setGeometry(QRect(10, 420, 261, 61))
        font1 = QFont()
...
"}")
        ...
        self.label.setGeometry(QRect(0, 100, 281, 31))
        self.frame_3 = QFrame(self.frame)
        self.frame_3.setObjectName(u"frame_3")
        self.frame_3.setGeometry(QRect(10, 10, 1051, 61))
        self.frame_3.setFrameShape(QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QFrame.Raised)
        self.label_2 = QLabel(self.frame_3)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(30, 20, 61, 21))
        self.label_2.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.filtro = QComboBox(self.frame_3)
        self.filtro.setObjectName(u"filtro")
        self.filtro.setGeometry(QRect(100, 20, 151, 22))
        ...
        self.Busqueda.setGeometry(QRect(270, 20, 441, 21))
        self.Busqueda.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.buscar = QPushButton(self.frame_3)
        self.buscar.setObjectName(u"buscar")
        self.buscar.setGeometry(QRect(720, 20, 151, 23))
        font2 = QFont()
        font2.setBold(True)
        font2.setWeight(75)
        self.buscar.setFont(font2)
        self.buscar.setStyleSheet(u"background-color: rgb(99, 99, 99);\n"
"color: rgb(255, 255, 255);")
        icon5 = QIcon()
        icon5.addFile(u"../assets/icons/new/art_pint/documento (1).png", QSize(), QIcon.Normal, QIcon.Off)
        self.buscar.setIcon(icon5)
        self.actualizar = QPushButton(self.frame_3)
        self.actualizar.setObjectName(u"actualizar")
        self.actualizar.setGeometry(QRect(880, 20, 151, 23))
        self.actualizar.setStyleSheet(u"background-color: rgb(99, 99, 99);\n"
"color: rgb(255, 255, 255);")
        icon6 = QIcon()
        icon6.addFile(u"../assets/icons/new/art_pint/reiniciar.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actualizar.setIcon(icon6)
        self.tabla = QTableWidget(self.frame)
        self.tabla.setObjectName(u"tabla")
        self.tabla.setGeometry(QRect(300, 80, 761, 411))
        self.tabla.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.frame_2 = QFrame(Tienda_Main)
        self.frame_2.setObjectName(u"frame_2")
        self.frame_2.setGeometry(QRect(10, 530, 1071, 101))
...
"}")
        icon7 = QIcon()
        icon7.addFile(u"../assets/icons/new/art_pint/usuario (2).png", QSize(), QIcon.Normal, QIcon.Off)
        self.Your_users.setIcon(icon7)
...
"}")
        icon8 = QIcon()
        icon8.addFile(u"../assets/icons/new/art_pint/grupo.png", QSize(), QIcon.Normal, QIcon.Off)
        self.More_users.setIcon(icon8)
...
"}")
        icon9 = QIcon()
        icon9.addFile(u"../assets/icons/new/art_pint/eliminar.png", QSize(), QIcon.Normal, QIcon.Off)
        self.Close_Main.setIcon(icon9)
...
"}")
        icon10 = QIcon()
        icon10.addFile(u"../assets/icons/new/art_pint/usuario.png", QSize(), QIcon.Normal, QIcon.Off)
        self.New_Users.setIcon(icon10)
...
"}")
        icon11 = QIcon()
        icon11.addFile(u"../assets/icons/new/art_pint/ajustes.png", QSize(), QIcon.Normal, QIcon.Off)
        self.Confg.setIcon(icon11)
...
"}")
        icon12 = QIcon()
        icon12.addFile(u"../assets/icons/new/art_pint/abra-bloqueo.png", QSize(), QIcon.Normal, QIcon.Off)
        self.Close_Users.setIcon(icon12)
    ...
    def retranslateUi(self, Tienda_Main):
        ...
        self.label_2.setText(QCoreApplication.translate("Tienda_Main", u"Buscar por : ", None))
        self.buscar.setText(QCoreApplication.translate("Tienda_Main", u"Buscar", None))
        self.actualizar.setText(QCoreApplication.translate("Tienda_Main", u"Actualizar", None))
